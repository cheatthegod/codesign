...
@dataclass
class GeometricProteinNCBIDesignConfig(FairseqDataclass):
...
@register_criterion("geometric_protein_ncbi_loss", dataclass=GeometricProteinNCBIDesignConfig)
class GeometricProteinLoss(FairseqCriterion):
    """
    Loss: Sequence recovery loss and structure prediction loss
    """

    def __init__(self, cfg: GeometricProteinNCBIDesignConfig, task):
        super().__init__(task)
        self.tpu = cfg.tpu
