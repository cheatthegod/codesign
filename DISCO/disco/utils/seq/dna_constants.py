...
from disco.utils.seq import amino_acid_constants, rna_constants
...
res_rep_atom_index = (
    11  # The index of the atom used to represent the center of the residue.
)
...
BIOMOLECULE_CHAIN = "polydeoxyribonucleotide"
